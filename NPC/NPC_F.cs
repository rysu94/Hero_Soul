...
public class NPC_F : MonoBehaviour {
    ...
    public void TurnPlayer()
    {
        ...
        {
            GetComponent<Animator>().Play("F" + NPC_ID + "_NPC_Right_Idle");
        }
        else if (angle > 45 && angle < 135)
        {
            GetComponent<Animator>().Play("F" + NPC_ID + "_NPC_Up_Idle");
        }
        else if (angle >= 135 && angle <= 225)
        {
            GetComponent<Animator>().Play("F" + NPC_ID + "_NPC_Left_Idle");
        }
        else if (angle > 225 && angle < 315)
        {
            GetComponent<Animator>().Play("F" + NPC_ID + "_NPC_Down_Idle");
        }
