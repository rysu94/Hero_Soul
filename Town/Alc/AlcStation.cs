...
public class AlcStation : MonoBehaviour
{
    ...
    IEnumerator TalkRoutine()
    {
        ...
        dialogue.GetComponent<DialogueController>().dialogueList.Add(new Dialogue("Would you like to use the alchemy station?", "Cecilia/Cecilia Grey_thigh_1", "Leon/Leon Klein_thigh_1", "NPC/NPC_Alc", "Theo", .9f, -1));
        ...
        if (decision == 1)
        {
            ...
            dialogueImg.SetActive(true);
            dialogue.GetComponent<DialogueController>().Clear();
            dialogue.GetComponent<DialogueController>().dialogueList.Add(new Dialogue("Excellent choice.", "Cecilia/Cecilia Grey_thigh_1", "Leon/Leon Klein_thigh_1", "NPC/NPC_Alc", "Theo", .9f, -1));
            dialogue.GetComponent<DialogueController>().StartDialogue();
        ...
        else if (decision == 2)
        {
            ...
            dialogueImg.SetActive(true);
            dialogue.GetComponent<DialogueController>().Clear();
            dialogue.GetComponent<DialogueController>().dialogueList.Add(new Dialogue("Another time then.", "Cecilia/Cecilia Grey_thigh_1", "Leon/Leon Klein_thigh_1", "NPC/NPC_Alc", "Theo", .9f, -1));
            dialogue.GetComponent<DialogueController>().StartDialogue();
            dialogue.GetComponent<DialogueController>().waitingDecision = false;
            while (!dialogue.GetComponent<DialogueController>().dialogueDone)
            {
