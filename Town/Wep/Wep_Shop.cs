...
public class Wep_Shop : MonoBehaviour
{
    ...
    IEnumerator TalkRoutine()
    {
        ...
        dialogue.GetComponent<DialogueController>().dialogueList.Add(new Dialogue("Would you like to browse my wares?", "Cecilia/Cecilia Grey_thigh_1", "Leon/Leon Klein_thigh_1", "NPC/NPC_Shopkeeper", "Grant", 1f, -1));
        ...
        else if (decision == 2)
        {
            ...
            dialogueImg.SetActive(true);
            dialogue.GetComponent<DialogueController>().Clear();
            dialogue.GetComponent<DialogueController>().dialogueList.Add(new Dialogue("Another time then.", "Cecilia/Cecilia Grey_thigh_1", "Leon/Leon Klein_thigh_1", "NPC/NPC_Shopkeeper", "Grant", 1f, -1));
            dialogue.GetComponent<DialogueController>().StartDialogue();
            dialogue.GetComponent<DialogueController>().waitingDecision = false;
